...
namespace UnitySlippyMap.Map
{
	...
	#region Singleton stuff
		...
		/// The instance.
		/// </summary>
		public static MapBehaviour instance = null;
	...
	#region Variables & properties
		...
		/// </summary>
		public double[] centerWGS84 = new double[2];
		...
		/// </summary>
		public double[] centerEPSG900913 = new double[2];
		...
		/// </summary>
		public float zoomStepUpperThreshold = 0.8f;
		...
		/// </summary>
		public float zoomStepLowerThreshold = 0.2f;
		...
		/// </value>
		public float halfMapScale = 0.0f;
		...
		/// </summary>
		public float roundedHalfMapScale = 0.0f;
		...
		/// </summary>
		public float metersPerPixel = 0.0f;
		...
		/// </summary>
		public float roundedMetersPerPixel = 0.0f;
		...
		/// </summary>
		public float roundedScaleMultiplier = 0.0f;
		...
		public float scaleDivider = 20000.0f;

		/// <summary>
		/// The tile resolution.
		/// </summary>
		public float tileResolution = 256.0f;
		...
		public bool usesLocation = false;
		...
		/// </summary>
		public bool updatesCenterWithLocation = true;
		...
		/// </summary>
		public bool usesOrientation = false;
		...
		/// </summary>
		public bool cameraFollowsOrientation = false;
		...
		/// </summary>
		public float lastCameraOrientation = 0.0f;

		/// <summary>
		/// The list of <see cref="UnitySlippyMap.Marker"/> instances.
		/// </summary>
		public List<MarkerBehaviour> markers = new List<MarkerBehaviour> ();
		...
		/// </summary>
		public bool showsGUIControls = false;
		...
		/// The location marker.
		/// </summary>
		public LocationMarkerBehaviour locationMarker;

		/// <summary>
		/// The list of <see cref="UnitySlippyMap.Layer"/> instances.
		/// </summary>
		public List<LayerBehaviour> layers = new List<LayerBehaviour> ();
		...
		/// </summary>
		public bool wasInputInterceptedByGUI;
    ...
    #region public methods
		...
		public double[] ComputeCenterEPSG900913 (double[] pos)
		{
